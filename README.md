...
Currently a **Technical Product Manager at [Tempo Labs](https://www.tempolabs.ai/) (YC23)**, where I manage $700K+ in ARR, build internal tooling used across the company, and deploy multi-agent orchestration systems with Claude-powered sub-agents. Before that I was shipping AI-powered features at **Flowmatic**, building analytics tools used daily at **Zynga** (Harry Potter: Puzzles & Spells, Words With Friends 2), and plugging AI micro-services into CRMs at **Repwave**.
...
| **[Atlas Code](https://8090-hackathon.vercel.app/)** | AI GitHub App that scans for tech debt and auto-opens PRs with fixes for security, DRY, and maintainability issues. Sub-agents analyze every push to `main`. | GitHub Apps, Supabase, TypeScript, AI Agents |
